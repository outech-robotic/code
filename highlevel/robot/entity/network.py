...
The NET_ADDRESS* elements define the hardware CAN addresses for ISOTP protocol.
"""
...
NET_ADDRESS_MOTOR = ISOTPAddress(_CAN_DEVICE,
                                 _net_get_rx_id(ID_OFFSET_MOTOR, 0),
                                 _net_get_tx_id(ID_OFFSET_MOTOR, 0))
NET_ADDRESSES_SERVO = [
...
NET_ADDRESS_SENSOR = ISOTPAddress(_CAN_DEVICE,
                                  _net_get_rx_id(ID_OFFSET_SENSOR, 0),
                                  _net_get_tx_id(ID_OFFSET_SENSOR, 0))
